...
void ALock::SetbIsKeyPlaced(bool bNewIsKeyPlaced)
{
	bIsKeyPlaced = bNewIsKeyPlaced;
	TriggerComp->SetCollisionEnabled(bIsKeyPlaced ? ECollisionEnabled::NoCollision
												  : ECollisionEnabled::QueryOnly);
	TriggerComp->Trigger(bIsKeyPlaced);
	KeyItemMesh->SetVisibility(bIsKeyPlaced);
}

bool ALock::GetbIsKeyPlaced(void)
{
	return bIsKeyPlaced;
}
